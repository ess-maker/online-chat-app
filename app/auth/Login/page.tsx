  ...
  return (
    ...
    <div className="max-w-md w-full p-6">
      ...
      <form action="#" method="POST" className="space-y-4">
        ...
        <div>
          <button type="submit" className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focus:bg-black  focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300">Sign Up</button>
        </div>
      </form>
      <div className="mt-4 text-sm text-gray-600 text-center">
        <p>Don't You Already have an account? <Link href="singup" className="text-black hover:underline">Singup here</Link>
        </p>
      </div>
    </div>
  </div>
