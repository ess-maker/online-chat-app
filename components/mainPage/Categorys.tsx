  ...
  <div className="2xl:mx-auto 2xl:container py-12 px-4 sm:px-6 xl:px-20 2xl:px-0 w-full">
    <div className="flex flex-col jusitfy-center items-center space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-4 md:gap-x-8 w-full">
        <div className="cursor-pointer duration-200  relative group flex justify-center items-center h-full w-full">
        ...
        <div className="cursor-pointer duration-200  relative group justify-center items-center h-full w-full hidden lg:flex">
        ...
        <div className="cursor-pointer duration-200  relative group flex justify-center items-center h-full w-full mt-4 md:hidden md:mt-8 lg:hidden">
      ...
      <div className="cursor-pointer duration-200  relative group hidden md:flex justify-center items-center h-full w-full mt-4 md:mt-8 lg:hidden">
        <img className="object-center object-cover h-full w-full hidden md:block" src="https://i.ibb.co/6FjW19n/olive-tatiane-Im-Ez-F9-B91-Mk-unsplash-2.png" alt="girl-image" />
