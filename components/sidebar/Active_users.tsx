...
const Active_users = () => {
  return (
    ...
    <div className="text-sm text-center mr-4">
        <button  className="flex flex-shrink-0 focus:outline-none  bg-gray-800 text-gray-600 rounded-full w-20 h-20"
                type="button">
                            {/* <Image
src='/addicon.svg'
width={21}
...
/> */}
    ...
    <div className="text-sm text-center mr-4"><div className="p-1 border-4 border-blue-600 rounded-full"><div className="w-16 h-16 relative flex flex-shrink-0">
        <img className="shadow-md rounded-full w-full h-full object-cover"
             ...
             alt=""
        />
    </div></div><p className='mt-2'>Anna</p></div>
    ...
    </div></div><p className='mt-2'>Jeff</p></div>
    <div className="text-sm text-center mr-4"><div className="p-1 border-4 border-blue-600 rounded-full"><div className="w-16 h-16 relative flex flex-shrink-0">
        <img className="shadow-md rounded-full w-full h-full object-cover"
             src="https://randomuser.me/api/portraits/women/42.jpg"
             alt=""
        />
    </div></div><p className='mt-2'>Cathy</p></div>
