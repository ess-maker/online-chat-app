...
const Chatheader = () => {
  return (
    ...
    <div className="flex">
        ...
        <Link href="#" className="block rounded-full hover:bg-gray-700 bg-gray-800 w-10 h-10 p-2">
        ...
        <Link href="#" className="block rounded-full hover:bg-gray-700 bg-gray-800 w-10 h-10 p-2 ml-4">
            <svg viewBox="0 0 20 20" className="w-full h-full fill-current text-blue-500">
